...
原文: https://github.com/PromeYang/fe-guide/blob/master/css-guide.md
...
**【强制】** （所有的）多个单词使用中划线，不允许使用小驼峰式命名或者下划线连接多个单词；

多个单词使用中划线，以提升名称的识别度，例如：`news-list`；
...
**【强制】** 使用 **tab** 字符做为一个缩进层级，不允许使用 **2** 个空格 或 **4** 个空格；
